...
Page({
  ...
  onLoad: function(options) {
    this.getJoinListByPHB();
    this.getVoteActivity(activeIDpersonal);
  },
  ...
  //获取个人排行榜初始化数据
  getJoinListByPHB: function() {
    var that = this;
    // 显示顶部刷新图标
    wx.showNavigationBarLoading();
    vote.getJoinListByPHB(limit, page, data => {
      // 隐藏导航栏加载框
  ...
  getJoinListByPHBLoad: function() {
    ...
    vote.getJoinListByPHB(limit, nextPage, data => {
      // 隐藏加载框
      wx.hideLoading();
      nextPage = data.nextPage;
      hasNextPage = data.hasNextPage;
