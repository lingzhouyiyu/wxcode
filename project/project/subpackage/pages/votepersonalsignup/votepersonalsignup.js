...
// pages/votepersonalsignup/votepersonalsignup.js
Page({
  ...
  //个人报名
  addJoinActivity:function(){
    vote.addJoinActivity(imageStr, introduce ,name,phone,data=>{
      console.log(data);
      isdisable = false;
      if(data.msg==200){
        // 隐藏加载框
        ...
        setTimeout(function () {
          wx.navigateTo({
            url: '../../pages/voteshare/voteshare?tag=personalshare' + '&name=' + data.data.name + '&number=' + data.data.id,
          })
        }, 1000) //延迟时间 这里是1秒
